...
class CartController {
    static async updateCart(req, res) {
        ...
        if (indexFound > -1) {
            ...
            // Попытка удалить несуществующий товар - просто игнорируем
            console.log('Trying to remove non-existent item, ignoring');
        }
